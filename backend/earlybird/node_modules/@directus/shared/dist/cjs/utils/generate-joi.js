...
function generateJoi(filter, options) {
    ...
    if (((_a = Object.keys(value)[0]) === null || _a === void 0 ? void 0 : _a.startsWith('_')) === false) {
        ...
        if (operator === '_starts_with') {
            schema[key] = ((_f = schema[key]) !== null && _f !== void 0 ? _f : Joi.string()).pattern(new RegExp(`^${lodash_1.escapeRegExp(compareValue)}.*`), {
                name: 'starts_with',
            });
        }
        if (operator === '_nstarts_with') {
            schema[key] = ((_g = schema[key]) !== null && _g !== void 0 ? _g : Joi.string()).pattern(new RegExp(`^${lodash_1.escapeRegExp(compareValue)}.*`), {
                name: 'starts_with',
                invert: true,
            });
        }
        if (operator === '_ends_with') {
            schema[key] = ((_h = schema[key]) !== null && _h !== void 0 ? _h : Joi.string()).pattern(new RegExp(`.*${lodash_1.escapeRegExp(compareValue)}$`), {
                name: 'ends_with',
            });
        }
        if (operator === '_nends_with') {
            schema[key] = ((_j = schema[key]) !== null && _j !== void 0 ? _j : Joi.string()).pattern(new RegExp(`.*${lodash_1.escapeRegExp(compareValue)}$`), {
                name: 'ends_with',
                invert: true,
            });
        }
