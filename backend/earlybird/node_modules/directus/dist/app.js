...
async function createApp() {
    ...
    try {
        new url_1.URL(env_1.default.PUBLIC_URL);
    }
    catch {
        logger_1.default.warn('PUBLIC_URL is not a valid URL');
    }
    await validate_storage_1.validateStorage();
    ...
    if ((await database_1.validateMigrations()) === false) {
        logger_1.default.warn(`Database migrations have not all been run`);
    }
    await cache_2.flushCaches();
    await extensions_2.initializeExtensions();
    extensions_2.registerExtensionHooks();
    ...
    extensions_2.registerExtensionEndpoints(customRouter);
