...
async function validateStorage() {
    if (env_1.default.DB_CLIENT === 'sqlite3') {
        try {
            await fs_extra_1.access(path_1.default.dirname(env_1.default.DB_FILENAME), fs_1.constants.R_OK | fs_1.constants.W_OK);
        }
        catch {
    ...
    if (env_1.default.STORAGE_LOCATIONS.split(',').includes('local')) {
        try {
            await fs_extra_1.access(env_1.default.STORAGE_LOCAL_ROOT, fs_1.constants.R_OK | fs_1.constants.W_OK);
        }
        catch {
    ...
    try {
        await fs_extra_1.access(env_1.default.EXTENSIONS_PATH, fs_1.constants.R_OK);
    }
    catch {
