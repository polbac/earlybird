...
class GraphQLService {
            ...
            for (const collection of Object.values(schema[action].collections)) {
                ...
                CollectionTypes[collection.collection] = schemaComposer.createObjectTC({
                    ...
                    fields: Object.values(collection.fields).reduce((acc, field) => {
                        let type = get_graphql_type_1.getGraphQLType(field.type);
    ...
    getQuery(rawQuery, selections, variableValues) {
        ...
        validate_query_1.validateQuery(query);
        return query;
    }
    /**
    ...
    injectSystemResolvers(schemaComposer, { CreateCollectionTypes, ReadCollectionTypes, DeleteCollectionTypes, }, schema) {
        ...
        schemaComposer.Query.addFields({
            extensions: {
                ...
                resolve: async () => ({
                    interfaces: extensions_1.listExtensions('interface'),
                    displays: extensions_1.listExtensions('display'),
                    layouts: extensions_1.listExtensions('layout'),
                    modules: extensions_1.listExtensions('module'),
                }),
            },
            server_specs_oas: {
        ...
        schemaComposer.Mutation.addFields({
            ...
            users_me_tfa_enable: {
                ...
                args: {
                    ...
                    secret: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                },
                resolve: async (_, args) => {
                    var _a;
                    if (!((_a = this.accountability) === null || _a === void 0 ? void 0 : _a.user))
        ...
        if ('directus_relations' in schema.read.collections) {
            Relation.addFields({
                ...
                schema: schemaComposer.createObjectTC({
                    ...
                    fields: {
                        table: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        column: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        foreign_key_table: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        foreign_key_column: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        constraint_name: graphql_1.GraphQLString,
                        on_update: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        on_delete: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                    },
                }),
                meta: schemaComposer.createObjectTC({
        ...
        if (((_b = this.accountability) === null || _b === void 0 ? void 0 : _b.admin) === true) {
            ...
            schemaComposer.Mutation.addFields({
                create_relations_item: {
                    type: Relation,
                    args: {
                        data: graphql_compose_1.toInputObjectType(Relation.clone('create_directus_relations'), { postfix: '_input' }).NonNull,
                    },
                    resolve: async (_, args) => {
                ...
                update_relations_item: {
                    ...
                    args: {
                        collection: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        field: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        data: graphql_compose_1.toInputObjectType(Relation.clone('update_directus_relations'), { postfix: '_input' }).NonNull,
                    },
                    resolve: async (_, args) => {
                        const relationsService = new relations_1.RelationsService({
                            accountability: this.accountability,
