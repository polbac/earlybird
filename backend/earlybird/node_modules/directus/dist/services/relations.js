...
class RelationsService {
    constructor(options) {
        ...
        this.schemaCache = cache_1.getCache().schemaCache;
    }
        ...
        await this.knex.transaction(async (trx) => {
            if (relation.related_collection) {
                await trx.schema.alterTable(relation.collection, async (table) => {
                    ...
                    const constraintName = get_default_index_name_1.getDefaultIndexName('foreign', relation.collection, relation.field);
                    const builder = table
        ...
        await this.knex.transaction(async (trx) => {
            if (existingRelation.related_collection) {
                await trx.schema.alterTable(collection, async (table) => {
                    var _a;
                    let constraintName = get_default_index_name_1.getDefaultIndexName('foreign', collection, field);
    ...
    async filterForbidden(relations) {
        ...
        relations = utils_1.toArray(relations);
