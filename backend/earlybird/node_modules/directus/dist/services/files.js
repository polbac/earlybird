...
class FilesService extends items_1.ItemsService {
    ...
    async uploadOne(stream, data, primaryKey) {
        ...
        const fileExtension = path_1.default.extname(payload.filename_download) || (payload.type && '.' + mime_types_1.extension(payload.type)) || '';
    ...
    async importOne(importURL, body) {
        ...
        const payload = {
            ...
            storage: utils_1.toArray(env_1.default.STORAGE_LOCATIONS)[0],
