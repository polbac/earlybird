...
class FieldsService {
    ...
    async readAll(collection) {
        ...
        const columnsWithSystem = columns.map((column) => {
            ...
            const { type = 'alias', ...info } = column ? get_local_type_1.default(column, field) : {};
            const data = {
        ...
        aliasFields = aliasFields.filter((field) => {
            const specials = utils_1.toArray(field.special);
    ...
    async readOne(collection, field) {
        ...
        const { type = 'alias', ...info } = column ? get_local_type_1.default(column, fieldInfo) : {};
        const data = {
            collection,
            field,
            type,
    ...
    async createField(collection, field, table // allows collection creation to
        ...
        const exists = field.field in this.schema.collections[collection].fields ||
            lodash_1.isNil(await this.knex.select('id').from('directus_fields').where({ collection, field: field.field }).first()) ===
                false;
    ...
    addColumnToTable(table, field, alter = null) {
        ...
        if ((_a = field.schema) === null || _a === void 0 ? void 0 : _a.has_auto_increment) {
            ...
            const helper = geometry_1.getGeometryHelper();
