...
router.get('/specs/oas', async_handler_1.default(async (req, res, next) => {
...
router.get('/specs/graphql/:scope?', async_handler_1.default(async (req, res) => {
    const service = new services_1.SpecificationService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.get('/info', async_handler_1.default(async (req, res, next) => {
...
router.get('/health', async_handler_1.default(async (req, res, next) => {
    const service = new services_1.ServerService({
        accountability: req.accountability,
        schema: req.schema,
    });
