...
router.post('/comment', async_handler_1.default(async (req, res, next) => {
    var _a;
    const service = new services_1.ActivityService({
        accountability: req.accountability,
        schema: req.schema,
...
router.patch('/comment/:pk', async_handler_1.default(async (req, res, next) => {
    const service = new services_1.ActivityService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.delete('/comment/:pk', async_handler_1.default(async (req, res, next) => {
    const service = new services_1.ActivityService({
        accountability: req.accountability,
        schema: req.schema,
    });
