...
router.get('/:collection', async_handler_1.default(async (req, res, next) => {
    const collectionsService = new services_1.CollectionsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.patch('/:collection', async_handler_1.default(async (req, res, next) => {
    const collectionsService = new services_1.CollectionsService({
        accountability: req.accountability,
        schema: req.schema,
    });
...
router.delete('/:collection', async_handler_1.default(async (req, res, next) => {
    const collectionsService = new services_1.CollectionsService({
        accountability: req.accountability,
        schema: req.schema,
    });
