...
async function up(knex) {
    const inspector = knex_schema_inspector_1.default(knex);
    ...
    for (const constraint of constraintsToAdd) {
        ...
        try {
            await knex.schema.alterTable(constraint.many_collection, (table) => {
                ...
                const indexName = get_default_index_name_1.getDefaultIndexName('foreign', constraint.many_collection, constraint.many_field);
                const builder = table
